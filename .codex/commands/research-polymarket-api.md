...
Use `.codex/skills/research-polymarket-api/SKILL.md` as the source of truth
for current Polymarket API and legal-assumption reviews.

When the user asks to verify non-paper mode assumptions:
...
- source-backed assumption table
- explicit unknowns
- no unsupported legality or profitability claims
