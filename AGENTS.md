...
- For an `optimize-money-mode` run, read `PROFITABILITY_ANALYSIS_2026.md`, `next_steps.md`, and `docs/POLYMARKET_REAL_MONEY_READINESS_PR_PLAN_2026-07-03.md` as the current planning ledger; use `docs/DUE_DILIGENCE_AUDIT_2026-07-08.md` for evidence, then re-verify external claims. These docs never authorize live mode.
