...
| C2 | Polymarket US (DCM): taker Θ=0.05, max ≈ $1.25/100 contracts at $0.50, maker rebate ≈ −$0.31/100, effective Apr 3 2026 | n/a | ❌ **unconfirmed** — current international maker pools distribute 20% of crypto, 15% of sports, and 25% of most other charged-category taker fees; no flat US DCM rebate was verified |
| C3 | Global CLOB category taker caps ≈ $0.75 sports / $1.00 politics-finance-tech / $1.25 economics-culture-weather / $1.80 crypto per 100 shares; geopolitics free; sells not charged | ✅ originally open; now partially addressed on `main` via CLOB/Gamma fee metadata parsing and fallback | ⚠️ **stale schedule**: current peaks are 1.75% crypto; 1.25% sports/economics/culture/weather/other; 1.00% finance/politics/mentions/tech; 0% geopolitics ([official schedule](https://docs.polymarket.com/trading/fees), accessed 2026-07-29) |
...
| # | Claim | Code check | External check |
|---|-------|-----------|----------------|
| G1 | DOJ/CFTC investigations ended Jul 2025; Polymarket acquired CFTC-licensed **QCEX** ($112M); launched **Polymarket US** (DCM); CFTC amended Order of Designation Nov 25 2025; ICE invested up to ~$2.6B | n/a | ✅ **confirmed** for the 2025 timeline, with corrections — see `PROFITABILITY_FACTCHECK_REPORT_JULY_2026.md` §2. June 2026 reports of a new CFTC investigation remain secondary-reported and publicly unconfirmed |
...
| C3 category taker caps | ⚠️ **STALE SCHEDULE** | Current international peaks: 1.75% crypto; 1.25% sports/economics/culture/weather/other; 1.00% finance/politics/mentions/tech; 0% geopolitics |
| C2 US DCM Θ=0.05/$1.25 cap/−$0.31 maker rebate | ❌ **UNCONFIRMED / likely wrong framing** | Current international maker pools distribute 20% of crypto, 15% of sports, and 25% of most other charged-category taker fees; no primary source surfaced for a flat US DCM rebate |
...
| **NEW nuance not in either PR** | ⚠️ | June 2026 secondary reports allege a new CFTC investigation, but no public agency confirmation was located in the 2026-07-29 recheck; treat this as a market signal, not a verified agency action |
...
materially new signal not in either PR: **secondary reports alleged a new CFTC investigation in June 2026**.
The agency did not publicly confirm it in the 2026-07-29 recheck, but the reports still defeat an "all clear."
